...
export function SiteHeader() {
  ...
  return (
    <header className="border-b border-pink-200/30 dark:border-pink-400/20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-md">
      <div className="mx-auto flex max-w-4xl flex-col gap-4 px-4 py-6 text-gray-900 dark:text-white sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
        ...
        <nav className="flex flex-wrap items-center gap-4 text-sm text-gray-700 dark:text-gray-300">
          {isHomePage ? (
            <>
              ...
              <Link href="mailto:support@where2meet.net" className="hover:text-gray-900 dark:hover:text-white transition-colors">
